        ...
        <script type="text/javascript">
            function doDelete(id) {
                if (confirm("are you sure to delete id = " + id)) {
                    window.location = "DeleteAssignment?id=" + id;
                }
            }
        </script>
    </head>
    <body>
        <div class="d-flex">
            ...
            <div class="container" style="margin-top: -20px">
                <div>
                    <div class="container">
                        <a href="AddAssignment" class="btn  p-2" style="background: #58abff; color: white; margin-bottom: 45px;margin-top: 30px "  >Add New Assignment</a>
                    </div>
                </div>
                        ...
                        <tbody>
                            <c:forEach items = "${requestScope.assignment}" var="c">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="UpdateAssignment?id=${id}" class="btn btn-warning">Update</a>
