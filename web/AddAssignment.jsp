    ...
    <body>
        <div class="d-flex">
            ...
            <div class="container mt-5">
                ...
                <form action="AddAssignment" id="courseForm2" onsubmit="return validateDates()" method="post">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-5">
                            ...
                            <input type="text" class="form-control" id="inputUsername4" placeholder="Assignment Name" required=""  name="name">
                        </div>
                        <div class="form-group col-md-5">

                            <label for="inputUsername4" style="font-weight: bold">Description </label>
                            <input type="text" class="form-control" id="inputUsername4" placeholder=" Description" required="" name="description">
                        </div>
