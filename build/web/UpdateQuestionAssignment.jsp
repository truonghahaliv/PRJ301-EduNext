    ...
    <body>
        <div class="d-flex">
            ...
            <div class="container mt-5">
                ...
                <form action="UpdateQuestionAssignment" onsubmit="return validateDates()" method="post">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-5">
                            ...
                            <input type="text" class="form-control" id="inputUsername4" placeholder=" Content" required="" value="${question.questionContent}" name="content">
                        </div>
