...
<!--                     <input value="${lid}" name="lid" hidden="">-->
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-5">
                            ...
                            <input type="text" class="form-control" id="inputUsername4" placeholder="Question Name" 
                                   value="${lessonQuestion.name}" required=""  name="name">
                        </div>
                        <div class="form-group col-md-5">

                            <label for="inputUsername4" style="font-weight: bold">Content </label>
                            <input type="text" class="form-control" id="inputUsername4" placeholder=" Content" required=""
                                   value="${lessonQuestion.content}" name="content">
                        </div>
