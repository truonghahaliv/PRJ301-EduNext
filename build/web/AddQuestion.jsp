    ...
    <body>
        <div class="d-flex">
            ...
            <div class="container mt-5">
                ...
                <form action="AddQuestion" onsubmit="return validateDates()" method="post">
                     <input value="${lid}" name="lid" hidden="">
                    <div class="form-row">

                        <div class="form-group col-md-5">

                            <label for="inputUsername4" style="font-weight: bold">Question Name </label>
                            <input type="text" class="form-control" id="inputUsername4" placeholder="Question Name" required=""  name="name">
                        </div>
                        <div class="form-group col-md-5">

                            <label for="inputUsername4" style="font-weight: bold">Content </label>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="date" class="form-control" id="start" placeholder="Start Date" required name="start">
                            <div id="startError" class="text-danger"></div>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="end" style="font-weight: bold">End Date</label>
                            <input type="date" class="form-control" id="end" placeholder="End Date" required name="end">
